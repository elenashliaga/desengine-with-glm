...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse items-start gap-2 group-data-[size=sm]/alert-dialog-content:flex group-data-[size=sm]/alert-dialog-content:flex-col-reverse sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    />
