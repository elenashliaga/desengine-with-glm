...
- [x] 2.4 Обновить `lib/task/task-progress-summary.ts` и `lib/task/task-progress-presentation.ts`, убрав зависимость от completion-reason
...
- [x] 3.1 Обновить фикстуры/юнит-тесты: `test/fixtures/task-progress.ts`, `test/unit/task-progress-summary.test.ts`, `test/unit/task-progress-presentation.test.ts`
